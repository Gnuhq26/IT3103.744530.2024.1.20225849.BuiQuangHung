...
public class AddCDToStoreScreenHbq extends JFrame {
    ...
    public AddCDToStoreScreenHbq(StoreHungBQ store) {
        this.store = store;
        ...
        btnSubmit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    CompactDiscHbq cd = new CompactDiscHbq(1, titleString, categoryString, authorString, artistString, lengthInt, costFloat);
